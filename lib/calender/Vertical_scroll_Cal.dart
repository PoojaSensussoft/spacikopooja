...
import 'package:spacikopooja/calender/DateUtils.dart';
import 'package:spacikopooja/calender/Month.dart';
...
class _MonthView extends StatefulWidget {
  ...
  const _MonthView({Key key, this.month, this.minDate, this.maxDate, this.monthBuilder,
    this.dayBuilder, this.onDayPressed, this.rangeMinDate, this.rangeMaxDate}) : super(key: key);


  @override
  __MonthViewState createState() => __MonthViewState(month, minDate, maxDate, monthBuilder, dayBuilder,
  onDayPressed, rangeMinDate, rangeMaxDate);
}
...
class __MonthViewState extends State<_MonthView> {
  ...
  __MonthViewState(this.month, this.minDate, this.maxDate, this.monthBuilder, this.dayBuilder, this.onDayPressed, this.rangeMinDate, this.rangeMaxDate);
  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        ...
        Table(
          children: month.weeks
              .map((Week week) => _generateFor(context, week, rangeMaxDate, rangeMinDate, minDate, maxDate, dayBuilder, onDayPressed))
              .toList(growable: false),
        ),
      ],
    );
...
TableRow _generateFor(BuildContext context, Week week, DateTime rangeMaxDate, DateTime rangeMinDate, DateTime minDate,
    DateTime maxDate, DayBuilder dayBuilder, onDayPressed) {
  DateTime firstDay = week.firstDay;
  bool rangeFeatureEnabled = rangeMinDate != null;
...
//     //   onTap: (){
//     //     decoration: BoxDecoration(
//     //               childolor: isSelected == true ? Colors.red : Colors.green,
//     //               shape: BoxShape.circle),
//     //   },
//     // );
//
...
//       width: 30,
//       decoration: BoxDecoration(
//           color: isSelected == true ? Colors.red : null,
//           shape: BoxShape.circle),
//
//       child: Center(
//         child: Text(
...
class _DefaultDayView extends StatefulWidget {
  ...
  @override
  __DefaultDayViewState createState() => __DefaultDayViewState(date, isSelected);
}
...
class __DefaultDayViewState extends State<_DefaultDayView> {
  ...
  __DefaultDayViewState(this.date, this.isSelected);
