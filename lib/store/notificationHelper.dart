...
import 'package:spacikopooja/store/ReminderNotification.dart';
...
Future<void> showNotification(
  ...
  await flutterLocalNotificationsPlugin.show(
      0, 'Natalia title', 'plain body', platformChannelSpecifics, payload: 'item x');
}
...
Future<void> scheduleNotification(
  ...
  var androidPlatformChannelSpecifics = AndroidNotificationDetails(id, 'Reminder notifications',
    'Remember about it', icon: 'app_icon',);
